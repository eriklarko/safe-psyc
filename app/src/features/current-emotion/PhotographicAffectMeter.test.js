...
import { findChildren, stringifyComponent, getAllRenderedStrings } from '~/tests/cool-test-lib/component-tree-utils.js';
...
function getImages(component) {
    return findChildren(component, Image).filter(i => i.props.source !== undefined);
}
