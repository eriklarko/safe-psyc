...
import { render, renderShallow } from '~/tests/cool-test-lib/render-utils.js';
import {
    findFirstChild,
    findChildren,
    ...
    findAllByTestId,
    stringifyComponent,
} from '~/tests/cool-test-lib/component-tree-utils.js';
...
it('has a link to the emotion details for each answer', () => {
    ...
    question.answers.forEach(ans =>
        expect(navigationMock)
            .toHaveNavigatedTo('EmotionDetails', {
                emotion: ans,
            })
    );
